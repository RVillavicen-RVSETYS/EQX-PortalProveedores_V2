...
class InicioController extends Controller
{
    ...
    {
        if ($this->debug == 1) {
            echo "<h2>Ya estamos dentro de controllers\ProveedorExtranjero\InicioController.php.</h2>";
        }
    ...
    public function index()
    {
        ...
        if ($menuData['success']) {
            if ($areaData['success']) {
                ...
                $this->view('ProveedorExtranjero/Inicio/index', $data);
            } else {
                $timestamp = date("Y-m-d H:i:s");
    ...
    public function tablaUltimas50Facturas()
    {
        ...
        // Cargar la vista correspondiente
        $this->view('ProveedorExtranjero/Inicio/listaCompras', $data);
    }
