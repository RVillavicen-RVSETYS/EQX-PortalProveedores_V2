...
class SoporteProveedorController extends Controller
{
    protected $debug = 0;
    ...
    {
        if ($this->debug == 1) {
            echo "<h2>Ya estamos dentro de controllers\ProveedorNacional\SoporteProveedorController.php.</h2>";
        }
    ...
    public function index()
    {
        ...
        if ($menuData['success']) {
            if ($areaData['success']) {
                ...
                $this->view('ProveedorNacional/SoporteProveedor/index', $data);
            } else {
                $timestamp = date("Y-m-d H:i:s");
                error_log("[$timestamp] app\controllers\ProveedorNacional\InicioController ->Error al listar las Areas: " . PHP_EOL, 3, LOG_FILE);
    ...
    public function contenedorManuales()
    {
        // Carga la vista de los manuales
        $data = [];
        $this->view('ProveedorNacional/SoporteProveedor/contenedorManuales', $data);
    }
