    ...
    public function authenticate()
    {
        ...
        if ($authResult['success']) {
            ...
            if ($verificaArea['success']) {
                ...
                // Logica de validacion de contraseña default mediante el HASH de la base de datos
                $hashDefault = '$2y$10$t0KYcBv5n04.VRhkuVOCr.p8VbfkSjnZtQFWyBXVjZqhLoAXxZMFe';
                if ($authResult['data']['pass'] === $hashDefault) {
                    $_SESSION['EQXCambioForzosoPass'] = true;
                } else {
                    $_SESSION['EQXCambioForzosoPass'] = false;
                }
