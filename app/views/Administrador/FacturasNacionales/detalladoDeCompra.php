...
<?php
            ...
            $urlPDF = base64_encode($data['dataCompra']['data']['FacUrlPDF']);
            $urlXML = base64_encode($data['dataCompra']['data']['FacUrlXML']);
    ...
    <div class="row show-grid">
        ...
        <div class="col-xs-6 col-md-4">
            <div class="text-right">
                <br>
                Factura:
                <button type="button" onclick="verFacturaPDF('<?= '/Administrador/FacturasNacionales/verDocumento/PDF/' . $urlPDF; ?>')" class="btn btn-outline-danger"><i class="far fa-file-pdf"></i> Ver PDF</button>
                <button type="button" onclick="verFacturaXML('<?= '/Administrador/FacturasNacionales/verDocumento/XML/' . $urlXML; ?>')" class="btn btn-outline-info"><i class="far fa-file-code"></i> Ver XML</button>
            </div>
        </div>
    </div>
    <div class="row show-grid">
