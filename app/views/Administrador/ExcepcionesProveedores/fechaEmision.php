        ...
        <div class="card">
            ...
            <div class="card-body border">
                <form id="agregarProveedorEFE">
                    <div class="row">
                        <label for="idProveedorEFE">Proveedores</label>
                        <div class="input-group mb-3">
                            <select name="idProveedor" id="idProveedorEFE" class="select2 form-control custom-select" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div id="desbloquear-btnEstatus3<?= $proveedor['IdExento']; ?>">
                                    <button id="btnEstatus3<?= $proveedor['IdExento']; ?>" onclick="cambiarEstatus(<?= $proveedor['Estatus']; ?>, <?= $proveedor['IdExento']; ?>, <?= 3 ?>,<?= $proveedor['IdProveedor']; ?>)" type="button" class="btn btn-xs btn-rounded <?= $color; ?>"><i class="<?= $icono; ?>"></i></button>
                                </div>
                            </td>
                        </tr>
                    <?php
