    ...
    <link rel="stylesheet" type="text/css" href="/dist/css/style-SilmeAgro.min.css">
    <!-- Vendor -->
    ...
    <!--Main Menu File-->
    <link rel="stylesheet" type="text/css" href="/assets/menu/webslidemenu/all-variables.css">    
    ...
    <link rel="stylesheet" type="text/css" href="/assets/libs/sweetalert2/dist/sweetalert2.min.css">
