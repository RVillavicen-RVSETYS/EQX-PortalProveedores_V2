            ...
            <div>
                <div class="row show-grid">
                    ...
                    <div class="col-xs-6 col-md-4">
                        ...
                        <p class="m-t-15"><b>Fecha Factura :</b> <?=$data['dataCompra']['data']['fechaFac'];?><br> 
                        <b>Fecha Recepción :</b> <?=$data['dataCompra']['data']['fechaReg'];?></p> 
                    </div>
                </div>
                <div class="row show-grid">
                    <div class="col-xs-6 col-md-4">
...
<script>
    ...
    function verFacturaPDF(pdfUrl){
        ...
        verCFDI.innerHTML = '<iframe src="'+pdfUrl+'" width="100%" height="500px" style="border:none;"></iframe>';
    }
