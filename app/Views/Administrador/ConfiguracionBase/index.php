                        ...
                        <div class="card">
                            ...
                            <div id="configuraciones" class="card-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#Correo" role="tab"><span class="hidden-sm-up"><i class="fas fa-envelope"></i></span> <span class="hidden-xs-down">Notificaciones</span></a> </li>
                                    <!--
                                            ...
                                            <div class="card border-left border-success border-bottom border-success">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center flex-row m-t-30">
                                                        ...
                                                        <div class="p-2">
                                                            <h3 class="m-b-0" id="selectRazonSocial">Empresa</h3><small id="selectRFC">RFC</small>
                                                        </div>
                                                    </div>
                                        ...
                                        <form id="formConfiguracionCorreo">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <small class="text-muted">Puede ingresar varios correos separándolos con una coma (,)</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3 align-items-start" style="margin-bottom: 50;">
                                                <!-- Botón de Guardar alineado y fijo al extremo de la derecha -->
                                                <div class="col-md d-flex justify-content-md-end justify-content-start align-items-start mt-3 mt-md-0"">
                                                    <div id=" bloquear-btnGuardarCorreo" style="display:none; margin-top: 32px;">
                                                    <button class="btn btn-primary btn-md" type="button" disabled>
                                                        <span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> Guardando...
                                                    </button>
                                                </div>
                                                <div id="desbloquear-btnGuardarCorreo" class="ml-2 ml-md-0" style="margin-top: 32px;">
                                                    <button type="submit" class="btn btn-md btn-outline-primary"><i class="fas fa-save mr-1"></i> Guardar</button>
                                                </div>
                                            </div>
                                    </div>
                            ...
                            <!-- FIN de la Tercera pestaña: Configuración de Correo para contacto-->
                        </div>
                    </div>
