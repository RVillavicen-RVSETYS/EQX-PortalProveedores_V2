...
class ProveedoresCompras_Mdl
{
    ...
    public function obtenerComprasProveedores($filtros = [], $agrupar = [], $valoresRetornar = [], $orden = [], $cantMaxRes = 0)
    {
        ...
        $filtrosDisponibles = [
            ...
            'insolutoPendiente' => ['tipoDato' => 'STRING', 'sqlFiltro' => ''], //Se usa true o false
        ...
        try {
            ...
            $sql = "SELECT * 
                    FROM (
                        ...
                        FROM compras cp 
	                    INNER JOIN proveedores pv ON cp.idProveedor = pv.id
                        WHERE $filtrosSQL
